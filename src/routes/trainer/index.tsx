...
function StatCard({ icon: Icon, label, value, trend, trendUp, accent = "indigo" }: StatCardProps) {
    ...
    <Card className="transition-shadow duration-200 hover:shadow-md">
      <CardContent className="p-5">
        <div className="flex items-center justify-between">
          ...
          {trend && (
            <span className={cn("text-[11px] font-semibold", trendUp ? "text-emerald-600" : "text-rose-500")}>
              {trend}
            </span>
          )}
        </div>
